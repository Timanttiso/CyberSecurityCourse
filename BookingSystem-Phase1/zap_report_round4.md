...
| --- | --- | --- | --- | --- |
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 72    |
| Info | Informational | http://localhost:8004 | Percentage of responses with status code 2xx | 63 % |
| Info | Informational | http://localhost:8004 | Percentage of responses with status code 3xx | 32 % |
