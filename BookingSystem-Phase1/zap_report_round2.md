...
| --- | --- | --- | --- | --- |
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 62    |
| Info | Informational | http://localhost:8002 | Percentage of responses with status code 2xx | 43 % |
| Info | Informational | http://localhost:8002 | Percentage of responses with status code 3xx | 39 % |
| Info | Exceeded Low | http://localhost:8002 | Percentage of responses with status code 4xx | 16 % |
